      ...
      <b-card no-body>
        <b-tabs card>
          <b-tab title="Day 1">
            ...
            <b-button class="float-right mr-4 mb-4" to="/japanese/create"><b-icon icon="plus-circle"></b-icon>
              Create
            </b-button>
            ...
            <b-card-text>
              <b-table :fields="fields" :items="dayFirst" :select-mode="selectMode" selectable
                ...
                <template #cell(action)="data">
                  <b-button v-if="!isShowAction" :to="`/japanese/` + data.item.id + `/update`">
        ...
        <b-tabs small card class="b-tab-mobile">
          <b-tab title="Day 1">
            <div class="button-mobile">
              ...
              <b-button size="sm" class="float-right mr-2 mb-2" to="/japanese/create"><b-icon icon="plus-circle"></b-icon>
                Create
              </b-button>
            </div>
            ...
            <b-card-text>
              <b-table :fields="fields" :items="dayFirst" :select-mode="selectMode" selectable
                ...
                <template #cell(action)="data">
                  <b-button size="sm" v-if="!isShowAction" :to="`/japanese/` + data.item.id + `/update`">
                    <b-icon icon="pencil"></b-icon>
                  </b-button>
          ...
          <b-tab title="Day 3">
            ...
            <b-button size="sm" class="float-right mr-2 mb-2" @click="deleteAllVocabulary()"><b-icon icon="trash"></b-icon>
              Delete
            </b-button>
            <b-button size="sm" class="float-right mr-2 mb-2" @click="showFull()"><b-icon icon="eye"></b-icon>
              Show
