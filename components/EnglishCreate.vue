  ...
  <b-container>
    <b-form @submit="onSubmit" @reset="onReset">
      <b-form-group id="input-group-1" label="English:" label-for="input-1">
        <b-form-input id="input-1" v-model="form.english" placeholder="Enter english"></b-form-input>
      </b-form-group>

      <b-form-group id="input-group-2" label="Vietnamese:" label-for="input-2">
        <b-form-input id="input-2" v-model="form.vietnamese" placeholder="Enter vietnamese"></b-form-input>
      </b-form-group>

      <b-form-group id="input-group-3" label="Example:" label-for="input-3">
        <b-form-textarea id="input-3" v-model="form.example" placeholder="Enter example" rows="3" max-rows="6"></b-form-textarea>
      </b-form-group>
